...
def summarize_data():
    ...
    team_data['승률'] = pd.to_numeric(team_data['승률'], errors='coerce')
    # team_data_grouped = team_data.groupby('연도').agg({'승률': 'mean'}).reset_index()
    team_data_grouped = team_data[team_data['팀명']=='삼성']
    ...
    hitter_data_grouped = hitter_data[hitter_data['팀명']=='삼성']
    ...
    pitcher_data_grouped = pitcher_data[pitcher_data['팀명']=='삼성']
    ...
    defense_data_grouped = defense_data[defense_data['팀명']=='삼성']
